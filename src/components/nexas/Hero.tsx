    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[var(--gradient-dark)]">
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center overflow-hidden">
          <span className="select-none whitespace-nowrap font-display text-[14vw] font-black leading-none text-primary/[0.05]">
            NexasStore
          </span>
        </div>
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-center px-4 py-4 text-center sm:px-6 sm:py-6">
          ...
          <h1
            className="animate-fade-up mt-4 max-w-3xl font-display text-2xl font-bold leading-tight sm:text-4xl"
            style={{ animationDelay: "0.1s" }}
          >
            Luxury Shopping,{" "}
            <span className="text-gold-gradient">Delivered</span> to Your Door
          </h1>

          <p
            className="animate-fade-up mt-2 max-w-xl text-base text-muted-foreground"
            style={{ animationDelay: "0.2s" }}
          >
            Discover a handpicked collection of premium products at NexasStore.
            Elegant, secure, and effortless shopping across Pakistan.
          </p>

          <div
            className="animate-fade-up mt-3 flex flex-wrap items-center justify-center gap-4"
